      ...
      <main className="bg-[#faf6e9]">
        <div className="max-w-[760px] mx-auto px-5 md:px-10 py-12 md:py-16 flex flex-col gap-10">
          <div className="flex flex-col gap-3">
            ...
            <p className="font-body text-[13px] text-[#b7a78c]">Last updated: August 8, 2026</p>
            <p className="font-body text-[15px] text-[#423926] leading-[1.7]">
          ...
          <Section heading="1. What Check Local First Is">
            <p>
          ...
          <Section heading="3. Business Listings &amp; Content">
            <p>
          ...
          <Section heading="4. Premium Memberships &amp; Payments">
            <p>
          ...
          <Section heading="5. Discount Codes">
            <p>
