...
const COPY = {
  backToAllBusinesses: "← All Businesses",
  callNow: "Call Now",
  visitWebsite: "VISIT WEBSITE",
  instagramLabel: "Instagram",
  facebookLabel: "Facebook",
  yelpLabel: "Yelp",
  heroAltSuffix: "storefront",
  pilotBadgeAlt: "Pilot Business",
  aboutHeading: "ABOUT",
  noDescriptionFallback: "No description provided yet.",
  ownerAlt: "Owner",
  meetPrefix: "MEET",
  meetTheOwnerHeading: "MEET THE OWNER",
  howTheyStartedHeading: "HOW THEY STARTED",
  visitUs: "VISIT US",
};
  ...
  return (
    <main className="bg-[#faf6e9]">
      ...
      <div className="hidden md:flex items-center justify-between bg-[#faf6e9] min-h-[275px] px-[64px] pt-[48px] pb-[32px] gap-[32px]">
        ...
        <div className="flex items-center gap-[16px] flex-shrink-0">
          ...
          {business.website_url && (
            ...
            >
              <span className="font-display font-bold text-[16px] text-white">{COPY.visitWebsite}</span>
              <svg
      ...
      <div className="md:hidden relative mx-[16px] mt-[24px] h-[240px] bg-[#c96f47] rounded-[12px] overflow-hidden">
        <Image src={heroPhotoUrl} alt={`${business.name} ${COPY.heroAltSuffix}`} fill priority sizes="100vw" className="object-cover" />
        {business.pilot_business && (
          <div className="absolute z-10 bottom-[8px] right-[8px] w-[96px] h-[82px]">
            <Image
              src={PILOT_BADGE_IMG}
              alt={COPY.pilotBadgeAlt}
              fill
              sizes="96px"
      ...
      <div className="hidden md:block relative">
        ...
        <div className="relative h-[700px] bg-[#b7a78c] overflow-hidden">
          <Image
            src={heroPhotoUrl}
            alt={`${business.name} ${COPY.heroAltSuffix}`}
            fill
            priority
            sizes="100vw"
        ...
        <div className="flex items-start pl-[139px] pr-[105px] gap-[253px]">
          ...
          <div className="relative flex-shrink-0 mt-[31px]">
            ...
            <div className="relative bg-[#faf6e9] rounded-[4px] shadow-[0px_8px_16px_0px_rgba(0,0,0,0.25)] w-[380px] h-[430px]">
              ...
              >
                <Image src={ownerPhotoUrl} alt={COPY.ownerAlt} fill sizes="330px" className="object-cover" />
              </div>
              <p
      ...
      <div className="md:hidden px-[16px] pb-[32px]">
        ...
        <div className="relative mt-[16px] h-[260px] bg-[#c9d2cf] rounded-[12px] overflow-hidden">
          <Image src={ownerPhotoUrl} alt={COPY.ownerAlt} fill sizes="100vw" className="object-cover" />
        </div>
