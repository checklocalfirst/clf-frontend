...
const FOUNDER_ALT = "Tessa Miller, Founder";

const MOBILE_STORY_HEADING = (
  <>The Check<br />Local First<br />Story</>
);

const COPY = {
  storyDesktopHeading: "THE CHECK LOCAL FIRST STORY",
  storyMobileEyebrow: "Our story",
  founderEyebrowDesktop: "MEET THE FOUNDER",
  founderEyebrowMobile: "Meet the founder",
  founderHeading: "Tessa's Story",
  signatureClosing: "With gratitude,",
  signatureName: "Tessa Miller, Founder",
  joinCtaDesktop: "JOIN THE COMMUNITY",
  joinHeadingMobile: "Come find your people",
  joinCtaMobile: "Join the community",
};
    ...
    <>
      ...
      <section className="hidden md:flex flex-col items-center gap-12 bg-[#faf6e9] px-[280px] py-[120px]">
        ...
        <div className="flex flex-col gap-8 w-full">
          <p className="font-display font-bold text-[13px] text-[#b7a78c] uppercase tracking-widest">{COPY.founderEyebrowDesktop}</p>
          <div className="relative h-[480px] w-full rounded-[12px] overflow-hidden">
            <Image src={IMG.founder} alt={FOUNDER_ALT} fill sizes="100vw" className="object-cover" />
          </div>
          <h2 className="font-display font-bold text-[32px] text-[#151814]">{COPY.founderHeading}</h2>
          <div className="flex flex-col gap-6">
            ...
            <div className="font-body italic text-[18px] text-[#151814] leading-relaxed">
              <p>{COPY.signatureClosing}</p>
              <p>{COPY.signatureName}</p>
            </div>
          </div>
        </div>
